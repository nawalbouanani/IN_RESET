    ...
    class App {
      constructor(container, options = {}) {
        ...
        this.renderer = new THREE.WebGLRenderer({
          antialias: false,
          alpha: true,
          powerPreference: "high-performance", // Añadir esto para usar GPU dedicada
      ...
      initPasses() {
        ...
        // Reducir la calidad del bloom para mejor rendimiento
        this.bloomPass = new EffectPass(
          this.camera,
          new BloomEffect({
            luminanceThreshold: 0.4, // Aumentar threshold
            luminanceSmoothing: 0,
            resolutionScale: 0.5, // Reducir resolución del bloom
            intensity: 0.8 // Reducir intensidad
          })
        );
        ...
        const smaaPass = new EffectPass(
          this.camera,
          new SMAAEffect({
            preset: SMAAPreset.LOW, // Cambiar a LOW
      ...
      init() {
        ...
        // Añadir listeners de hover en el contenedor
